// CvSU Don Severino de las Alas Campus (Indang) — campus data.
//
// Split out of app/lib/campusMap.ts, which stays as the barrel every caller
// imports. This half is pure literals and the accessors over them: ~390 lines
// of the BUILDINGS coordinate table used to bury the routing logic beside it.
...
/** Return BUILDINGS with x/y replaced by admin overrides where present. */
export function applyCoordOverrides(
  overrides: ReadonlyMap<string, { x: number; y: number }>,
): Building[] {
  if (overrides.size === 0) return BUILDINGS.slice();
...
export const ROADS: readonly Road[] = [
  { points: [{ x: 302, y: 2066 }, { x: 1808, y: 2066 }] },
  { points: [{ x: 656, y: 1924 }, { x: 678, y: 1846 }, { x: 826, y: 1846 }, { x: 944, y: 1840 }, { x: 1075, y: 1840 }, { x: 1023, y: 1846 }, { x: 1258, y: 1846 }, { x: 1514, y: 1846 }] },
  { points: [{ x: 678, y: 1846 }, { x: 656, y: 1924 }, { x: 721, y: 1678 }, { x: 793, y: 1388 }, { x: 721, y: 1110 }, { x: 689, y: 987 }] },
  { points: [{ x: 793, y: 1388 }, { x: 944, y: 1678 }, { x: 1180, y: 1517 }, { x: 1258, y: 1711 }, { x: 1343, y: 1762 }] },
  { points: [{ x: 427, y: 1175 }, { x: 623, y: 1207 }, { x: 682, y: 1194 }, { x: 878, y: 1045 }, { x: 1114, y: 942 }, { x: 1252, y: 1052 }] },
  { points: [{ x: 440, y: 858 }, { x: 538, y: 858 }, { x: 944, y: 858 }, { x: 1173, y: 858 }, { x: 1369, y: 858 }, { x: 1435, y: 936 }] },
  { points: [{ x: 1363, y: 1207 }, { x: 1291, y: 1194 }, { x: 1461, y: 1045 }, { x: 1435, y: 936 }, { x: 1514, y: 781 }, { x: 1612, y: 742 }] },
  { points: [{ x: 1173, y: 793 }, { x: 1514, y: 781 }, { x: 1121, y: 638 }, { x: 977, y: 638 }, { x: 1023, y: 593 }] },
  { points: [{ x: 1612, y: 742 }, { x: 1494, y: 677 }, { x: 1599, y: 580 }] },
  { points: [{ x: 911, y: 419 }, { x: 1081, y: 283 }, { x: 1193, y: 419 }] },
  { points: [{ x: 446, y: 948 }, { x: 427, y: 1071 }, { x: 427, y: 1175 }, { x: 427, y: 1291 }, { x: 492, y: 1517 }] },
  { points: [{ x: 689, y: 987 }, { x: 610, y: 1097 }, { x: 538, y: 858 }] },
  { points: [{ x: 689, y: 987 }, { x: 682, y: 1194 }, { x: 793, y: 1388 }] },
  { points: [{ x: 1180, y: 1517 }, { x: 1435, y: 1388 }, { x: 1572, y: 1517 }, { x: 1572, y: 1381 }] },
  { points: [{ x: 1435, y: 1388 }, { x: 1363, y: 1207 }] },
  { points: [{ x: 1514, y: 781 }, { x: 1494, y: 677 }, { x: 1599, y: 580 }] },
];
...
export const STREET_LABELS: readonly StreetLabel[] = [
  { text: "Indang-Trece Martires Road", x: 1127, y: 2040, rotation: 0 },
  { text: "Purok 1", x: 224, y: 1007, rotation: -90 },
  { text: "Architect Edward Alimboyoguen St.", x: 839, y: 1498, rotation: -90 },
];

// Campus outline — traced from the official Matayuyon campus map.
export const CAMPUS_OUTLINE: ReadonlyArray<{ x: number; y: number }> = [
  { x: 577, y: 1963 }, { x: 787, y: 1988 }, { x: 1023, y: 1995 }, { x: 1284, y: 1988 }, { x: 1514, y: 1982 }, { x: 1651, y: 1950 }, { x: 1664, y: 1782 }, { x: 1651, y: 1614 }, { x: 1644, y: 1433 }, { x: 1651, y: 1265 }, { x: 1651, y: 1110 }, { x: 1651, y: 942 }, { x: 1658, y: 774 }, { x: 1644, y: 619 }, { x: 1586, y: 490 }, { x: 1481, y: 387 }, { x: 1389, y: 283 }, { x: 1284, y: 206 }, { x: 1180, y: 193 }, { x: 1101, y: 180 }, { x: 1023, y: 206 }, { x: 996, y: 283 }, { x: 839, y: 335 }, { x: 839, y: 490 }, { x: 892, y: 619 }, { x: 944, y: 748 }, { x: 839, y: 800 }, { x: 604, y: 800 }, { x: 446, y: 793 }, { x: 394, y: 890 }, { x: 368, y: 1007 }, { x: 368, y: 1200 }, { x: 381, y: 1368 }, { x: 342, y: 1459 }, { x: 368, y: 1562 }, { x: 433, y: 1601 }, { x: 486, y: 1562 }, { x: 525, y: 1678 }, { x: 551, y: 1846 }, { x: 577, y: 1963 },
];
...
// Road-aligned waypoint graph. Every neighbor pair shares either an x
// (same vertical road) or a y (same horizontal road), so the polyline
// between consecutive waypoints stays on a single straight road segment.
// Corner nodes (wp_sw, wp_int_w_admin, wp_int_e_mid) bridge perpendicular
// roads so cross-traffic doesn't cut diagonally through buildings.
export const WAYPOINTS: Record<string, Waypoint> = {
  // ── SOUTH ARTERIAL (y = 1700) ─────────────────────────────────────
  wp_sw:         { id: "wp_sw",         x: 691,  y: 1700, neighbors: ["wp_clinic", "wp_gate1", "wp_plaza", "wp_west"] },
  wp_plaza:      { id: "wp_plaza",      x: 770,  y: 1700, neighbors: ["wp_clinic", "wp_gate1", "wp_south_row", "wp_sw"] },
  wp_gate1:      { id: "wp_gate1",      x: 857,  y: 1700, neighbors: ["wp_central", "wp_gate3", "wp_plaza", "wp_softball", "wp_south_row", "wp_sw", "wp_west"] },
  wp_south_row:  { id: "wp_south_row",  x: 1030, y: 1700, neighbors: ["wp_gate1", "wp_gate3", "wp_mall", "wp_plaza"] },
  wp_mall:       { id: "wp_mall",       x: 1130, y: 1700, neighbors: ["wp_boys_dorm", "wp_gate3", "wp_girls_dorm", "wp_south_row"] },
  wp_gate3:      { id: "wp_gate3",      x: 1208, y: 1700, neighbors: ["wp_bahay", "wp_boys_dorm", "wp_gate1", "wp_gym", "wp_mall", "wp_south_row"] },
  wp_boys_dorm:  { id: "wp_boys_dorm",  x: 1280, y: 1700, neighbors: ["wp_bahay", "wp_gate3", "wp_girls_dorm", "wp_mall"] },
  wp_girls_dorm: { id: "wp_girls_dorm", x: 1370, y: 1700, neighbors: ["wp_bahay", "wp_boys_dorm", "wp_mall"] },

  // ── WEST PERIMETER (x = 691) ──────────────────────────────────────
  wp_softball:    { id: "wp_softball",    x: 691, y: 1500, neighbors: ["wp_central", "wp_clinic", "wp_gate1", "wp_oval", "wp_west"] },
  wp_west:        { id: "wp_west",        x: 691, y: 1450, neighbors: ["wp_clinic", "wp_gate1", "wp_softball", "wp_sw"] },
  wp_clinic:      { id: "wp_clinic",      x: 691, y: 1370, neighbors: ["wp_ccj", "wp_oval", "wp_plaza", "wp_softball", "wp_sw", "wp_west"] },
  wp_ccj:         { id: "wp_ccj",         x: 691, y: 1250, neighbors: ["wp_chapel", "wp_clinic", "wp_int_w_admin", "wp_oval"] },
  wp_int_w_admin: { id: "wp_int_w_admin", x: 691, y: 1150, neighbors: ["wp_admin", "wp_ccj", "wp_chapel", "wp_coed", "wp_gate2", "wp_oval"] },
  wp_coed:        { id: "wp_coed",        x: 770, y: 1150, neighbors: ["wp_admin", "wp_ceit", "wp_gate2", "wp_int_w_admin"] },
  wp_chapel:      { id: "wp_chapel",      x: 691, y: 1100, neighbors: ["wp_ccj", "wp_gate2", "wp_int_w_admin"] },
  wp_gate2:       { id: "wp_gate2",       x: 691, y: 1050, neighbors: ["wp_ceit", "wp_chapel", "wp_coed", "wp_int_w_admin"] },
  wp_ceit:        { id: "wp_ceit",        x: 691, y: 950,  neighbors: ["wp_admin", "wp_coed", "wp_gate2", "wp_oval"] },

  // ── CENTRAL SPINE (x = 857) ───────────────────────────────────────
  wp_oval:    { id: "wp_oval",    x: 857, y: 1500, neighbors: ["wp_admin", "wp_ccj", "wp_ceit", "wp_central", "wp_clinic", "wp_int_w_admin", "wp_softball"] },
  wp_central: { id: "wp_central", x: 857, y: 1370, neighbors: ["wp_gate1", "wp_oval", "wp_softball"] },
  wp_admin:   { id: "wp_admin",   x: 857, y: 1150, neighbors: ["wp_ceit", "wp_coed", "wp_int_w_admin", "wp_oval"] },

  // ── EAST-CENTRAL (x = 1100) ───────────────────────────────────────
  wp_grad:    { id: "wp_grad",    x: 1100, y: 1150, neighbors: ["wp_cafenr", "wp_cas", "wp_con", "wp_hostel", "wp_library", "wp_processing", "wp_research"] },
  wp_library: { id: "wp_library", x: 1100, y: 1083, neighbors: ["wp_grad", "wp_hostel"] },
  wp_osas:    { id: "wp_osas",    x: 1100, y: 1370, neighbors: ["wp_bahay", "wp_gym", "wp_int_e_mid"] },

  // ── EAST SPINE (x = 1208) ─────────────────────────────────────────
  wp_bahay:     { id: "wp_bahay",     x: 1208, y: 1600, neighbors: ["wp_boys_dorm", "wp_gate3", "wp_girls_dorm", "wp_gym", "wp_int_e_mid", "wp_osas", "wp_processing"] },
  wp_gym:       { id: "wp_gym",       x: 1208, y: 1500, neighbors: ["wp_bahay", "wp_gate3", "wp_osas"] },
  wp_int_e_mid: { id: "wp_int_e_mid", x: 1208, y: 1370, neighbors: ["wp_bahay", "wp_osas", "wp_processing"] },
  wp_cas:       { id: "wp_cas",       x: 1208, y: 1083, neighbors: ["wp_con", "wp_grad", "wp_hostel", "wp_north_ring"] },
  wp_con:       { id: "wp_con",       x: 1208, y: 1000, neighbors: ["wp_cas", "wp_grad", "wp_icon", "wp_north_ring", "wp_rolle"] },

  // ── FAR EAST (x = 1300, 1383) ─────────────────────────────────────
  wp_processing: { id: "wp_processing", x: 1300, y: 1370, neighbors: ["wp_bahay", "wp_cafenr", "wp_cemds", "wp_grad", "wp_int_e_mid"] },
  wp_cafenr:     { id: "wp_cafenr",     x: 1300, y: 1300, neighbors: ["wp_cemds", "wp_grad", "wp_processing", "wp_research"] },
  wp_cemds:      { id: "wp_cemds",      x: 1383, y: 1300, neighbors: ["wp_cafenr", "wp_processing"] },
  wp_research:   { id: "wp_research",   x: 1383, y: 1180, neighbors: ["wp_cafenr", "wp_grad", "wp_hostel"] },
  wp_hostel:     { id: "wp_hostel",     x: 1383, y: 1000, neighbors: ["wp_bano", "wp_cas", "wp_grad", "wp_library", "wp_north_ring", "wp_research"] },
  wp_north_ring: { id: "wp_north_ring", x: 1300, y: 850,  neighbors: ["wp_bano", "wp_cas", "wp_con", "wp_das", "wp_hostel", "wp_icon"] },
  wp_bano:       { id: "wp_bano",       x: 1450, y: 800,  neighbors: ["wp_das", "wp_hostel", "wp_north_ring"] },
  wp_das:        { id: "wp_das",        x: 1300, y: 700,  neighbors: ["wp_bano", "wp_cvmbs", "wp_icon", "wp_north_ring", "wp_star_farm"] },

  // ── NORTH ZONE (x = 1100, y decreasing = moving north) ────────────
  wp_rolle:     { id: "wp_rolle",     x: 1100, y: 900, neighbors: ["wp_con", "wp_icon"] },
  wp_icon:      { id: "wp_icon",      x: 1100, y: 800, neighbors: ["wp_con", "wp_cvmbs", "wp_das", "wp_north_ring", "wp_rolle", "wp_star_farm"] },
  wp_cvmbs:     { id: "wp_cvmbs",     x: 1100, y: 700, neighbors: ["wp_das", "wp_icon", "wp_star_farm"] },
  wp_star_farm: { id: "wp_star_farm", x: 1100, y: 580, neighbors: ["wp_cvmbs", "wp_das", "wp_icon"] },
};
